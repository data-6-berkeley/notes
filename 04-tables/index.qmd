...
This lecture we will return to the dataset of public universities in California ([Wikipedia](https://en.wikipedia.org/wiki/List_of_colleges_and_universities_in_California)).

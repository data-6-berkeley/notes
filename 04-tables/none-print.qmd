...
We have covered a few data types so far. There are *infinitely* many integers, floating point numbers, and strings. (Actually *finite*, because of how computers store information. Take [CS61C](https://cs61c.org/) to learn more.)

...
1. Navigate to the file explorer on DataHub.
  1. Save your changes in your notebook.
  1. In the top-right, on the menu bar, click on the dropdown "Open with..." and select "NBClassic." This should open your notebook in a new tab.
  1. In the new tab of your notebook, click the Jupyter logo in the top left of your screen. If a pop-up appears saying you have unsaved changes, continue to leave the page (this is because you should still have your original tab with your notebook in it.)
...
1. Paste your Client Access Token as a string, assigning it to the name `my_client_access_token`.
  ...
  1. Save and exit.
1. Return to your assignment file by closing this tab. You should still have your original tab with your notebook in it; if not, navigate to the notebook from the course website.

...
* Can use the area principle to explain histogram shape and bin area/dimensions.
* Can compute area and proportion from bin dimensions.
* Can interpret bin density as a measure of bin "crowdedness" with respect to the distribution.
